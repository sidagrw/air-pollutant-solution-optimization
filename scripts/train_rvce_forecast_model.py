...
model_output = Path("models/trained/rvce_forecast_random_forest.pkl")
metrics_output = Path("outputs/metrics/rvce_forecast_model_metrics.csv")
predictions_output = Path("outputs/predictions/rvce_forecast_predictions.csv")
...
def pm25_aqi(x):
    if x <= 30:
        return sub_index(x, 0, 30, 0, 50)
    elif x <= 60:
        return sub_index(x, 31, 60, 51, 100)
    elif x <= 90:
        return sub_index(x, 61, 90, 101, 200)
    elif x <= 120:
        return sub_index(x, 91, 120, 201, 300)
    elif x <= 250:
        return sub_index(x, 121, 250, 301, 400)
    else:
        return sub_index(x, 251, 500, 401, 500)


def pm10_aqi(x):
    if x <= 50:
        return sub_index(x, 0, 50, 0, 50)
    elif x <= 100:
        return sub_index(x, 51, 100, 51, 100)
    elif x <= 250:
        return sub_index(x, 101, 250, 101, 200)
    elif x <= 350:
        return sub_index(x, 251, 350, 201, 300)
    elif x <= 430:
        return sub_index(x, 351, 430, 301, 400)
    else:
        return sub_index(x, 431, 600, 401, 500)


def no2_aqi(x):
    if x <= 40:
        return sub_index(x, 0, 40, 0, 50)
    elif x <= 80:
        return sub_index(x, 41, 80, 51, 100)
    elif x <= 180:
        return sub_index(x, 81, 180, 101, 200)
    elif x <= 280:
        return sub_index(x, 181, 280, 201, 300)
    elif x <= 400:
        return sub_index(x, 281, 400, 301, 400)
    else:
        return sub_index(x, 401, 1000, 401, 500)
...
def prepare(df, medians=None, label="data"):
    ...
    # Predict next time-step AQI using only weather/date fields available in advance
